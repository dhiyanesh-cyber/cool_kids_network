  ...
  return (
    <Router>
      <div className="min-h-screen bg-gray-100 flex flex-col">
        <nav className="bg-cool-blue text-white p-4 shadow-md">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <ul className="flex space-x-4 items-center">
              {!user ? (
                <>
                  <li>
                    <Link to="/signup" className="flex items-center hover:bg-cool-blue-dark px-3 py-2 rounded transition">
                      <FaUserPlus className="mr-2" /> Signup
                    </Link>
                  </li>
                  <li>
                    <Link to="/login" className="flex items-center hover:bg-cool-blue-dark px-3 py-2 rounded transition">
                ...
                <>
                  <li>
                    <Link to="/profile" className="flex items-center hover:bg-cool-blue-dark px-3 py-2 rounded transition">
                      <FaUser className="mr-2" /> Profile
                    </Link>
                  </li>
                  {(user.role === 'Cooler Kid' || user.role === 'Coolest Kid') && (
                    <li>
                      <Link to="/users" className="flex items-center hover:bg-cool-blue-dark px-3 py-2 rounded transition">
        ...
        <footer className="bg-cool-gray text-white p-4 text-center">
